        ...
        if msg.toType == 2:
            if msg.contentType == 0:
                ...
                if msg.text == "gift":
                    sendMessage(msg.to, text="gift sent", contentMetadata=None, contentType=9)
                if msg.text == "set":
                    sendMessage(msg.to, "Siap dah membaca sider nah hehe")
                    try:
                ...
                if msg.text == "tes":
                    if msg.to in wait['readPoint']:
                        ...
                        sendMessage(msg.to, "Tukang baca chat %s\nbungul\n\nSudah membaca kada membalas ha pulang\n%skontlo ♪\n\nJam nya nah:\n[%s]"  % (wait['readMember'][msg.to],chiya,setTime[msg.to]))
                    else:
                        sendMessage(msg.to, "Kadada yang meread pesan")
                else:
                    pass
        else:
            pass
